...
{
    internal class InputLiv
    {
        public static bool RT(){
            return instance().rightControllerIndexFloat == 1f;
        }

        public static bool LT(){
            return instance().leftControllerIndexFloat == 1f;
        }
        public static bool RG(){

            return instance().rightControllerGripFloat == 1f;
        }
        public static bool LG(){
            return instance().leftControllerGripFloat == 1f;
        }
